                ...
                <div className="p-0 m-0 container-fluid">
                    ...
                    <div className="breadcrumb-header justify-content-between">
                        <div className="left-content respon_aligment">
                            <span className="main-content-title mg-b-0 mg-b-lg-1">Matrix Residuals</span>
                        </div>
                        <div className="justify-content-center mt-2">
                            <ol className="breadcrumb breadcrumb-style3 Br_ps">
                                ...
                                <li className="breadcrumb-item active g_clr" aria-current="page">Matrix Residuals </li>
                            </ol>
                        </div>
                    </div>
                    {/* <!-- /breadcrumb --> */}
...
export default Matrix_residual_1
